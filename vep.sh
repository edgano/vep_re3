...
/lustre/scratch118/humgen/resources/ensembl/vep/singularity_containers/vep_104.0.sif \
vep \
--cache \
--dir_cache /opt/vep/.vep/ \
--fasta /opt/vep/.vep/homo_sapiens/104_GRCh38/Homo_sapiens.GRCh38.dna.toplevel.fa.gz \
--offline \
--format vcf \
...
--plugin dbNSFP,/opt/vep/.vep/Plugins/dbNSFP4.1a.gz,Ensembl_transcriptid,Uniprot_acc,VEP_canonical,LRT_pred,SIFT_pred,MutationTaster_pred,Polyphen2_HDIV_pred,Polyphen2_HVAR_pred \
...
--plugin LoF,loftee_path:/opt/vep/.vep/Plugins,human_ancestor_fa:/opt/vep/.vep/Plugins/GRCh38_human_ancestor.fa.gz,conservation_file:/opt/vep/.vep/Plugins/loftee.sql,gerp_bigwig:/opt/vep/.vep/Plugins/90_mammals.gerp_conservation_scores.homo_sapiens.GRCh38.bw,debug:1 \
